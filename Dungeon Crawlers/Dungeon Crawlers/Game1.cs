...
namespace Dungeon_Crawlers
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            slimeTextures = Content.Load<Texture2D>("Images/Sprites/Slime-Spritesheet");
            ...
            //Loads the player
            player = new Player(goblinTextures, new Hitbox(new Rectangle(500, 500, goblinTextures.Width, goblinTextures.Height), BoxType.Hitbox)
                , screenWidth, screenHeight);
